...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 py-4 px-5" style="overflow-y: scroll; height: calc(100vh);">
                <div style="display: flex; flow-direction: row; align-items: center;">
                    <a href="../profile.php" class="btn" style="margin-right: 30px;">
                        <img src="../../assets/leftArrow.png">
                    </a>
                    <h1 style="color: #213A5C;">Edit Profile</h1>
                </div>
                    ...
                    <div class="py-4">
                        <div style="display: flex; flow-direction: row; width: 100%;">
                            <div class="form-group" style="flex: 1;">
                                ...
                                <input type="text" name="name" class="form-control py-3" required value="<?php echo $adminDoc['name']; ?>">
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flow-direction: row; flex: 1;">
                            <div class="form-group" style="flex: 1; margin-right: 100px;">
                                ...
                                <input type="text" name="phone_number" class="form-control py-3" required value="<?php echo $adminDoc['phone_number']; ?>">
                            </div>
                            <div class="form-group" style="flex: 1;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class = "file form-control py-3" required value="<?php echo $adminDoc['email']; ?>">
                        </div>
                    </div>
