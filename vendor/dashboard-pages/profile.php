    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <p>Name: <?php echo $adminDoc['name']; ?></p>
                <p>Address: <?php echo $adminDoc['address']; ?></p>
                <p>Contact Number: <?php echo $adminDoc['phone_number']; ?></p>
                <p>Email: <?php echo $adminDoc['email']; ?></p>
