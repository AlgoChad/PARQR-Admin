...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                ...
                <div class="profile">
                    <a href="profile.php" class="nav-link d-flex align-items-center">
                        <img src="admin.jpg" alt="Admin Image" class="">
                        <div>
                        <h5 class="mb-0"><?php echo $adminDoc['name']; ?></h5>
            ...
            <!-- Main Content -->
            <div class="col-md-10">
                <h1>Welcome to the Operators</h1>
                    <a class="nav-link d-flex align-items-center" href="operator-screens/register_operator.php">
                        <img src="../assets/nav-icons/transactions.png" alt="Transactions Icon" class="mr-3">
                        ...
                        <div class="col-md-10">
                            <table class="table table-bordered">
                                ...
                                <?php foreach ($docs as $doc) : ?>
                                    <?php if ($doc->exists()) : ?>
                                        <tr>
                                            <td><?php echo $doc->get('name'); ?></td>
                                            <td><?php echo $doc->get('operator_id'); ?></td>
                                            <td><?php echo $doc->get('hired_by'); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                                </tbody>
